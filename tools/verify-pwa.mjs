...
const checks = [
  ...
  ['spatial viewer removed', !/type="module" src="runtime\/spatial-viewer\.js"/.test(html)],
  ['runtime modules cached offline', ['./runtime/install.js','./runtime/spatial-navigation.mjs','./runtime/spatial-reconstruction.mjs','./runtime/sparse-voxel-world.mjs','./runtime/surface-world-simulation.mjs'].every(file => worker.includes(String.fromCharCode(39)+file+String.fromCharCode(39)))],
];
let failed = false;
