...
const checks = [
  ...
  ["editor-Assets (CSS/JS) cached offline", ["./editor/engine-shell.css?v=1","./editor/app.js?v=9","./editor/facade.js","./editor/world-sandbox.css?v=2","./editor/world-sandbox.js?v=2"].every(file => worker.includes(`'${file}'`))],
