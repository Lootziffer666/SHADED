...
// scratch-real-image-reconstruct.mjs's newtest-reconstructed.json) from
...
const data = JSON.parse(fs.readFileSync('/tmp/claude-0/-home-user-SHADED/28c78061-b0e0-5f7f-bdfd-27d37e45d96b/scratchpad/newtest-reconstructed.json', 'utf8'));
...
(async () => {
  ...
  fs.writeFileSync(path.join(OUT, 'real-image-turntable.png'), Buffer.from(b64, 'base64'));
  console.log('Wrote real-image-turntable.png');
  await browser.close();
})();
