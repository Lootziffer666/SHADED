...
const raw = JSON.parse(fs.readFileSync('/tmp/claude-0/-home-user-SHADED/28c78061-b0e0-5f7f-bdfd-27d37e45d96b/scratchpad/newtest-raw2d.json', 'utf8'));
...
fs.writeFileSync('/tmp/claude-0/-home-user-SHADED/28c78061-b0e0-5f7f-bdfd-27d37e45d96b/scratchpad/newtest-reconstructed.json', JSON.stringify({ W, H, R: state2.R, pp: state2.pp, f: state2.f, T: finalT, vertices: Object.fromEntries(cubeNames.map(n => [n, state.cubes[n].vertices])), localCoords }, null, 2));
console.log('Wrote newtest-reconstructed.json');
