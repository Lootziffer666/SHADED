...
(async () => {
  ...
  const WALL_HEIGHT = 0.85, ROOF_HEIGHT = 0.55; // fixed, openly-labelled, shared by all -- not derived this round
  ...
  const palettes = [
    [[212, 175, 55], [58, 92, 168], [150, 120, 40], [40, 65, 120], [196, 60, 48], [150, 45, 36]],
    [[120, 200, 140], [90, 150, 220], [80, 140, 95], [60, 100, 155], [230, 150, 60], [180, 110, 40]],
    [[200, 120, 190], [120, 190, 200], [140, 80, 130], [80, 130, 140], [220, 90, 70], [160, 60, 45]],
    [[190, 190, 90], [150, 100, 200], [130, 130, 60], [100, 65, 140], [90, 200, 190], [55, 140, 130]],
  ];
  const faces = houses.flatMap((h, i) => buildBox(h, palettes[i % palettes.length]));
  ...
  fs.writeFileSync(path.join(OUT, 'manhattan-n-houses.png'), Buffer.from(b64, 'base64'));
  console.log('Wrote manhattan-n-houses.png');
