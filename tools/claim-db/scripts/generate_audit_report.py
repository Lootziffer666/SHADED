...
EVIDENCE = {
    ...
    "A-0801": ("GOAL_ALFRED.md A-0800", "real atomic claims with traceable original_text provenance from both a CHAT_EXPORT (C-SAND-0001) and a DOC source (C-CONFLICT-G0006-GOAL)", "tools/test-claim-db.mjs"),
    "A-0806": ("GOAL_ALFRED.md A-0800", "AUD-20260906-EXT0004 chains to AUD-20260906-CHAT001 via previous_audit_id; delta finding scoped to the new claim only, first audit's 3 findings untouched", "tools/test-claim-db.mjs"),
